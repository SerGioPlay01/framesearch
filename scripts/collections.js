...
class CollectionsManager {
                ...
                <div class="modal-content modal-small">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="collectionDescription" placeholder="Краткое описание коллекции" rows="3"></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="poster-upload">
                                ...
                                <input type="text" id="collectionPosterUrl" placeholder="Или вставьте URL изображения">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn-secondary" onclick="collectionsManager.close()">Отмена</button>
    ...
    async open(collectionId = null) {
        ...
        if (collectionId) {
            ...
            document.querySelector('#collectionModal .modal-header h2').textContent = 'Редактировать коллекцию';
        } else {
            this.editMode = false;
            this.editCollectionId = null;
            this.reset();
            document.querySelector('#collectionModal .modal-header h2').textContent = 'Создать коллекцию';
        }
    }
    ...
    async save() {
        ...
        if (!name) {
            await dialog.alert('Введите название коллекции', 'Ошибка валидации');
            return;
        }
